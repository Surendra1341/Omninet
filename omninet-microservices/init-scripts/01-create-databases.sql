...
SELECT 'CREATE DATABASE omninet_chat' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'omninet_chat')\gexec
...
GRANT ALL PRIVILEGES ON DATABASE omninet_chat TO postgres;
